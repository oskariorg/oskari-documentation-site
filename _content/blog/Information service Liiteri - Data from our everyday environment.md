...
Liiteri is an information service focusing on the living environment and is governed by Finnish Environment Institute (Syke). Geospatial data and statistics about the built environment and land use planning have been gathered in Liiteri.
...
Liiteri development started already in 2012 when there was a huge national program for "Enhancing the electronic democracy tools" (SADe). During that program a map service was being developed by the NLS-FI (later known as Oskari). Liiteri was one of the first Oskari instances after Paikkatietoikkuna.
...
The service is also useful for students and researchers. Citizens can search for information about their neighbourhood’s services or the current situation of land use planning.
